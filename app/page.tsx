  ...
  return (
    <div className="flex flex-col h-auto flex-grow items-center justify-center px-4">
      ...
      <p className="text-xl text-gray-600 mb-8 text-center max-w-2xl">
        Hi, I'm Merrick. Welcome to my personal blog where I share my thoughts
        on coding, technology, and more. Join me on my journey as I explore new
        ideas, share my experiences, and connect with like-minded individuals.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl">
        ...
        <section className="p-6 border rounded-lg hover:shadow-lg transition-shadow">
          ...
          <p className="text-gray-600">
            Feel free to reach out to me through the contact page. I'm always
            open to discussing new ideas, collaborations, or just having a chat
            about technology.
          </p>
        </section>
      </div>
